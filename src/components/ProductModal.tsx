...
export interface Product {
    ...
    projection: number;
    occasions: string[];
    presentations: Presentation[]; // Available presentations for this product
}
...
export default function ProductModal({ product, onClose }: ProductModalProps) {
    // Default to 10ml for better conversion, fallback to first available
            ...
            {product && (
                ...
                >
                    ...
                    >
                        ...
                        <button
                            onClick={onClose}
                            className="absolute top-6 right-6 p-2 text-white/60 hover:text-white z-20 transition-colors"
                        >
                        ...
                        <div className="p-8 md:p-12 lg:p-16 flex flex-col justify-center">
                            <span className="text-accent text-xs tracking-[0.3em] uppercase mb-4">
                                {product.gender}
                            </span>
                            ...
                            {/* Presentation Selector - Elegant Pills */}
                            <div className="mb-8">
                                <span className="text-xs tracking-[0.2em] uppercase text-white/40 block mb-4">
                                    Presentación
                                </span>
                                ...
                                <p className="text-white/30 text-xs mt-3 italic">
                                    Ideal para probar antes de decidir el frasco.
                                </p>
                            </div>
                            ...
                            {/* CTA with selected presentation */}
                            <a
                                href={whatsappUrl}
                                target="_blank"
